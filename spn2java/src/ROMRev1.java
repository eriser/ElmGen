...
// 
// 
public class ROMRev1 extends ElmProgram {
  public ROMRev1() {
    super("ROMRev1");
    setSamplerate(48000);
    ...
    allocDelayMem("ap1b", 1751);
    allocDelayMem("ap2", 1443);
    allocDelayMem("ap2b", 1343);
    allocDelayMem("ap3", 1582);
    allocDelayMem("ap3b", 1981);
    allocDelayMem("ap4", 1274);
    allocDelayMem("ap4b", 1382);
    allocDelayMem("del1", 5859);
    allocDelayMem("del2", 4145);
    allocDelayMem("del3", 3476);
    allocDelayMem("del4", 4568);
    int temp = REG0;
    int lpf1 = REG1;
    int lpf2 = REG2;
    int lpf3 = REG3;
    ...
    chorusReadDelay(CHO_LFO_SIN0, 1, "ap3", (int)(51));
    ...
    readDelay("lap1", 1.0, -0.5);
    writeAllpass("lap1", 0, 0.5);
    readDelay("lap2", 1.0, -0.5);
    writeAllpass("lap2", 0, 0.5);
    readDelay("lap3", 1.0, -0.5);
    writeAllpass("lap3", 0, 0.5);
    readDelay("lap4", 1.0, -0.5);
    writeAllpass("lap4", 0, 0.5);
    writeRegister(lapout, 0);
    readRegister(ADCR, 0.5);
    readDelay("rap1", 1.0, -0.5);
    writeAllpass("rap1", 0, 0.5);
    readDelay("rap2", 1.0, -0.5);
    writeAllpass("rap2", 0, 0.5);
    readDelay("rap3", 1.0, -0.5);
    writeAllpass("rap3", 0, 0.5);
    readDelay("rap4", 1.0, -0.5);
    writeAllpass("rap4", 0, 0.5);
    writeRegister(rapout, 0);
    readDelay("del4", 1.0, 1.0);
    mulx(rt);
    readRegister(lapout, 1.0);
    readDelay("ap1", 1.0, -0.6);
    writeAllpass("ap1", 0, 0.6);
    readDelay("ap1b", 1.0, -0.6);
    writeAllpass("ap1b", 0, 0.6);
    writeRegister(temp, 1.0);
    readRegisterFilter(lpf1, 0.5);
    writeRegisterHighshelf(lpf1, -1.0);
    mulx(lf);
    readRegister(temp, 1.0);
    writeRegister(temp, 1.0);
    readRegisterFilter(hpf1, 0.05);
    writeRegisterLowshelf(hpf1, -1.0);
    mulx(hf);
    readRegister(temp, 1.0);
    ...
    readDelay("ap2b", 1.0, -0.6);
    writeAllpass("ap2b", 0, 0.6);
    writeRegister(temp, 1.0);
    readRegisterFilter(lpf2, 0.5);
    writeRegisterHighshelf(lpf2, -1.0);
    mulx(hf);
    readRegister(temp, 1.0);
    writeRegister(temp, 1.0);
    readRegisterFilter(hpf2, 0.05);
    writeRegisterLowshelf(hpf2, -1.0);
    mulx(lf);
    readRegister(temp, 1.0);
    writeDelay("del2", 0, 0.0);
    readDelay("del2", 1.0, 1.0);
    mulx(rt);
    readRegister(rapout, 1.0);
    readDelay("ap3", 1.0, -0.6);
    writeAllpass("ap3", 0, 0.6);
    readDelay("ap3b", 1.0, -0.6);
    writeAllpass("ap3b", 0, 0.6);
    writeRegister(temp, 1.0);
    readRegisterFilter(lpf3, 0.5);
    writeRegisterHighshelf(lpf3, -1.0);
    mulx(hf);
    readRegister(temp, 1.0);
    writeRegister(temp, 1.0);
    readRegisterFilter(hpf3, 0.05);
    writeRegisterLowshelf(hpf3, -1.0);
    mulx(lf);
    readRegister(temp, 1.0);
    ...
    readDelay("ap4b", 1.0, -0.6);
    writeAllpass("ap4b", 0, 0.6);
    writeRegister(temp, 1.0);
    readRegisterFilter(lpf4, 0.5);
    writeRegisterHighshelf(lpf4, -1.0);
    mulx(hf);
    readRegister(temp, 1.0);
    writeRegister(temp, 1.0);
    readRegisterFilter(hpf4, 0.05);
    writeRegisterLowshelf(hpf4, -1.0);
    mulx(lf);
    readRegister(temp, 1.0);
    writeDelay("del4", 0, 0.0);
    readDelay("del1", (int)(2630), 1.5);
    readDelay("del2", (int)(1943), 1.2);
    readDelay("del3", (int)(3200), 1.0);
    readDelay("del4", (int)(4016), 0.8);
    writeRegister(DACL, 0.0);
    readDelay("del3", (int)(1163), 1.5);
    readDelay("del4", (int)(3330), 1.2);
    readDelay("del1", (int)(2420), 1.0);
    readDelay("del2", (int)(2631), 0.8);
