...
// wra	apd4+80,0
public class RevPl2 extends ElmProgram {
  public RevPl2() {
    super("RevPl2");
    setSamplerate(48000);
    allocDelayMem("api1l", 123);
    allocDelayMem("api2l", 224);
    allocDelayMem("api3l", 546);
    allocDelayMem("api4l", 868);
    allocDelayMem("api1r", 213);
    allocDelayMem("api2r", 342);
    allocDelayMem("api3r", 421);
    allocDelayMem("api4r", 978);
    allocDelayMem("apd1", 1301);
    allocDelayMem("apd2", 1902);
    allocDelayMem("apd3", 2171);
    allocDelayMem("apd4", 1401);
    allocDelayMem("del1", 2620);
    allocDelayMem("del2", 2591);
    allocDelayMem("del3", 2387);
    allocDelayMem("del4", 2679);
    int temp = REG0;
    int krt = REG1;
    int ksh = REG2;
    int ksl = REG3;
    ...
    readDelay("del3", (int)(1897), 0.6);
    readDelay("del4", (int)(280), 0.5);
    writeRegister(DACL, 0);
    readDelay("del1", (int)(1897), 0.8);
    readDelay("del2", (int)(1245), 0.7);
