...
// wra	apd4+80,0
public class RevPl3 extends ElmProgram {
  public RevPl3() {
    super("RevPl3");
    setSamplerate(48000);
    allocDelayMem("api1l", 123);
    allocDelayMem("api2l", 264);
    allocDelayMem("api3l", 606);
    allocDelayMem("api4l", 768);
    allocDelayMem("api1r", 163);
    allocDelayMem("api2r", 322);
    allocDelayMem("api3r", 591);
    allocDelayMem("api4r", 778);
    allocDelayMem("apd1", 1201);
    allocDelayMem("apd2", 782);
    allocDelayMem("apd3", 1071);
    allocDelayMem("apd4", 947);
    allocDelayMem("del1", 1190);
    allocDelayMem("del2", 1091);
    allocDelayMem("del3", 1287);
    allocDelayMem("del4", 1379);
    int temp = REG0;
    int krt = REG1;
    int ksh = REG2;
    int ksl = REG3;
    ...
    readDelay("del3", (int)(697), 0.6);
    readDelay("del4", (int)(580), 0.5);
    writeRegister(DACL, 0);
    readDelay("del1", (int)(697), 0.8);
    readDelay("del2", (int)(845), 0.7);
